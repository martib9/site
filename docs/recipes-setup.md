...
Alphamega manual search uses `/usearch?q=TERM`, verified through the live site search box on 13 September 2026. The previous `/en/groceries?Search=TERM` route returned an empty category page. Garlic results loaded without a postcode or delivery selection.
